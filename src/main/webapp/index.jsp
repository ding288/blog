	...
	<div class="blog-masthead">
		<div class="container">
			<nav class="blog-nav">
				...
				<a class="blog-nav-item" href="#"><s:text name="timeline" /></a>
				<a class="blog-nav-item" href="#"><s:text name="about" /></a>
				<a class="blog-nav-item" style="float: right;" href="#"><s:text name="rigist" /></a>
				<a class="blog-nav-item" style="float: right;" href="#"><s:text name="login" /></a>
			</nav>		
		</div>
	</div>
